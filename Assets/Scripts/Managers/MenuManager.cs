...
public class MenuManager : Singleton<MenuManager>
{
	...
	void Start ()
	{
		...
		MainMenuLocomotive.transform.DOLocalRotate (new Vector3 (0, 0, 40), 2f).From ().OnStart (() => MainMenuLocomotive.gameObject.SetActive (true)).SetDelay (1.2f).SetEase (Ease.OutExpo);
