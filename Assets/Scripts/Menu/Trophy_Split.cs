...
public class Trophy_Split : MonoBehaviour
{
    ...
    void EnableElement(Transform t)
    {
        t.GetComponent<MeshRenderer>().enabled = true;
        t.GetChild(0).GetComponent<MeshRenderer>().enabled = false;
    }

    void DisableElement(Transform t)
    {
